export const ProductGroups = [
    ...
    {
      name: 'Clothing',
      subcategories: ['Men', 'Women', 'Kids', 'Accessories', 'Shoes', 'Activewear', 'Sleepwear', 'Jewelry']
    },
    {
      name: 'Home & Kitchen',
      subcategories: ['Furniture', 'Appliances', 'Decor', 'Bedding', 'Lighting', 'Cookware', 'Storage & Organization', 'Rugs']
    },
    {
      name: 'Beauty & Health',
      subcategories: ['Skincare', 'Haircare', 'Makeup', 'Fragrances', 'Health Supplements', 'Personal Care', 'Oral Care', 'Bath & Body']
    },
    {
      name: 'Toys & Games',
